...
RSpec.describe PublicCompany do
  ...
  it 'increases its market cap when it gets better than expected revenues' do
    ...
    expect(after_market_cap - before_market_cap).to match a_value_between(50_000, 1_000_000)
  end
  ...
  it 'provides attributes' do
    ...
    # expect(company.market_cap).to eq(1_100_000)

    # More readable failure message
    expect(company).to have_attributes(name: 'Nil', value_per_share: 10, share_count: 100_000, market_cap: 1_100_000)
  end
